...
<main>
    <nav style="--wails-draggable:drag" class="container">
        <div class="navbar">
            <h2>RemindMe</h2>
            <button on:click={() => navigate("reminder")}>
                <svg
                    pointer-events="none"
                    width="26"
                    height="26"
                ...
                >
                    <path
                        d="M18.0002 5V19M10 5L6 19M14 5L12 19"
                        stroke-width="2"
...
<style>
    ...
    h2 {
        color: white;
        /* border-bottom: 2px solid  rgb(100, 219, 31); */
        max-width: 20%;
    }
